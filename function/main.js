...
function discount(price, percent) {
  ...
  console.log(`My discounted Price : EUR ${discountedPrice}`);
}
...
//     return n * 2;
//   }
//   const result = double(5); // result sis now 10
...
/*
const myNewPrice = formatPrice(20, "EUR");
console.log(myNewPrice); */

//console.log(formatPrice(20, "EUR"));
...
function printCart(cart) {
  for (let i = 0; i < cart.length; i++) {
    ...
    //console.log(item.name + " " + formatPrice(item.price, "EUR"));
  }
}
