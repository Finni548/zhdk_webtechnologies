...
const cart = [
  { name: "Tomatoes", price: 2.5, quantity: 3 },
  { name: "Bread", price: 4.2, quantity: 1 },
  { name: "Olive Oil", price: 8.9, quantity: 2 },
  { name: "Cheese", price: 6.3, quantity: 1 },
  { name: "Pasta", price: 1.8, quantity: 4 },
];
...
function applyDiscount(total, percent) {
  ...
  console.log(`After 10% discoun: CHF 21.30${discounted.toFixed(2)}`);
}
